...
@FunctionHint(output = @DataTypeHint("ROW<" +
        ...
        "ApplSeqNum           String,\n" +
        "OrderNO              String>"))
public class XshgStockOrderAuction extends TableFunction<Row> {


    Logger logger = LoggerFactory.getLogger(XshgStockOrderAuction.class);
    ...
    public void eval(byte[] rawData)  {
        try {
            ...
            if (name.equals("OrderType")){
                ...
                row.setField(16,mdOrder.getOrderNO()+"");
                collect(row);
            }
        } catch (Throwable t) {
