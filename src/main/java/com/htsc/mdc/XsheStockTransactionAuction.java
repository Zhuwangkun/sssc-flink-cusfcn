...
import com.htsc.mdc.model.MDTransactionRecordProtos;
...
@FunctionHint(output = @DataTypeHint("ROW<" +
        ...
        "ChannelNo                String,\n" +
        "ApplSeqNum               String>"))
public class XsheStockTransactionAuction extends TableFunction<Row> {


    Logger logger = LoggerFactory.getLogger(XsheStockTransactionAuction.class);
