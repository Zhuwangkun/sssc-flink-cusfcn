...
@FunctionHint(output = @DataTypeHint("ROW<" +
        ...
        "min_price                      String              ,\n" +
        "avg_price                      String              ,\n" +
        "uplimited_price                String              ,\n" +
        "downlimited_price              String              ,\n" +
        "stock_stop_flag                String              ,\n" +
        "business_date                  String              ,\n" +
        "yesterday_deal_amount          String              ,\n" +
        "market_deal_amount             String              ,\n" +
        "market_deal_balance            String              ,\n" +
        "position_quantity              String              ,\n" +
        "pre_position_quantity          String              ,\n" +
        "buy_price1                     String              ,\n" +
        "sale_price1                    String              ,\n" +
        "settle_price                   String              ,\n" +
        "pre_settle_price               String              ,\n" +
...
public class BbTstockhq extends TableFunction<Row> {

    Logger LOG = LoggerFactory.getLogger(BbTstockhq.class);
    ...
    public void eval(byte[] rawData) {
        try {
            ...
            if (this.schemaName.equalsIgnoreCase("dbreport") && this.tableName.equalsIgnoreCase("bb_tstockhq")) {
...
//            if (this.columeName.equalsIgnoreCase("pre_settle_price")){
//                break;
//            }
        }
